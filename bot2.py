...
#path = [(239,508), (219,505), (197,546), (209,584), (288,578), (285,551), 
#       (274,493), (267,474), (261,474),(262,477),(254,477)]

'''path = [(170, 32), (240, 34), (336, 45), (412, 29), (477, 52), (570, 46), 
        (600, 55), (622, 42), (671, 75), (670, 152), (640, 210), (570, 220), 
        (550, 276), (500, 251), (400, 244), (355, 293), (380, 340), (367, 414), 
        (440, 420), (486, 381), (512, 336), (547, 300), (630, 300), (636, 350), 
        (630, 408), (631, 463), (600, 500), (613, 546), (600, 581), (571, 614), 
        (540, 636), (482, 656), (435, 662), (400, 680), (367, 657), (320, 612), 
        (280, 610), (224, 621), (160, 625), (120, 560), (120, 500), (100, 460), 
        (110, 420), (105, 371), (107, 300), (103, 216), (113, 182), (151, 162), 
...
while True:                
 ...
 # stucks processing
   if (lastCoord[(j-1) % len(lastCoord)] == lastCoord[(j-2) % len(lastCoord)] and 
       lastCoord[(j-1) % len(lastCoord)] == lastCoord[(j-3) % len(lastCoord)]):
      print('stuck')
      ...
      alpha = getAngle(playerCoord, playerVec, path[i])
      autoit.mouse_move(mouse.get_position()[0] + int(alpha * 2.19), 
                        mouse.get_position()[1], 20)
      time.sleep(0.5)
      keyboard.press('w')
      keyboard.press(']')
   ...
   if (upLeft[0] <= playerCoord[0] <= downRight[0] and 
      upLeft[1] >= playerCoord[1] >= downRight[1]):   
      i += 1
      i %= len(path)
